...
# Define folders for logs and secure passwords
...
# Create a function to log actions to log file
log_action() {
...
create_user() {
    ...
    # defines three variables passed to the function: user, groups, and password
    local user="$1"
    local groups="$2"
    local password
...
echo "User created sucessfully. Run cat /var/log/user_management.log for more details."
